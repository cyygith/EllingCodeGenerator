                	...
                	<el-row :gutter="24">
                        ...
                        <el-col :span="7">
                            <el-form-item label="查看次数" prop="readCount">
                                <el-input v-model="form.readCount" size="small"></el-input>
                            </el-form-item>
                        </el-col>	
                	</el-row>
                	<el-row :gutter="24">
                        <el-col :span="7">
                            <el-form-item label="点赞次数" prop="zanCount">
                                <el-input v-model="form.zanCount" size="small"></el-input>
                            </el-form-item>
                        </el-col>	
                		<el-col :span="7">
        ...
        <div class="list-panel">
            ...
            <div class="list-list">
                <el-table border style="width: 100%" :data="tableData" ref="multipleTable">
                        ...
                        <el-table-column prop="zanCount" label="点赞次数"></el-table-column>
